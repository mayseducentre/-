...
export default function News() {
  ...
  useEffect(() => {
    // Try to load news data from local db.json file
    fetch("/db.json")
      .then((res) => res.json())
      .then((data) => {
        // If your db.json has a section for news, adjust accordingly
        // Example assumes you stored blog posts under "blog" or "library[0].news"
        const blogs = data.blog || data.library?.[0]?.blog || [];
        setBlog(blogs);
        setLoading(true);
      })
      .catch((err) => console.error("Error loading local news JSON:", err));
  }, []);
  ...
  return (
    <>
      ...
      <Breadcrumb
        ...
        image="https://lh3.googleusercontent.com/pw/AP1GczPUCocKMxC4wGVcuARVjp01biMREjUpBLF8kb06utd3X07oBJV-Avdh3tiqrcCtff9ZoFv2FDL3Cntewt5Kq6NDxapUD8XKAf8RIR-9s2EwdWKfLaw"
      />
      <br />
      <br />
      ...
      <section id="recent-posts" className="recent-posts sections-bg">
        <div className="container" data-aos="fade-up">
          <div className="section-header">
            ...
            <p>
              Find out the most exciting and interesting information from our
              blog.
            </p>
          </div>
