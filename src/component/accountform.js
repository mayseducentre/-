...
function Postaccount(){
   ...
   if(passconfirm !== passcode){
    document.getElementById("passcode_account").style.backgroundColor="red"
    
    document.getElementById("passcode_confirm").style.backgroundColor="red";
            ...
            <div className="row">
                <div className="col-lg-8 col-md-6">
                    ...
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="checkout__input">
                                <p>Name<span>*</span></p>
                                <input type="text" id="name_account" required/>
                            </div>
                        </div>
                    ...
                    <div className="checkout__input">
                        ...
                        <select id="country_account" style={select}>
        ...
        <option value="Zimbabwe">Zimbabwe</option>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6">
                            <div className="checkout__input">
                                <p>Email<span>*</span></p>
                                <input type="email" id="email_account" placeholder="Valid email" required/>
                            </div>
                            ...
                            <div className="checkout__input">
                                ...
                                <input type="password" id="passcode_confirm" placeholder="Confirm password" required/>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-6">
                            <div className="checkout__input">
                                <p>Role<span>*</span></p>
                                <select style={select} id="role_account">
