                                                                                                                                                                    ...
                                                                                                                                                                    .then(() => {
                                                                                                                                                                            setProjects(projects.filter((project) => project.id !== id));
                                                                                                                                                                                        ...
                                                                                                                                                                                        .catch((error) => console.error("Error deleting project:", error));
                                                                                                                                                                                            ...
                                                                                                                                                                                            return (
                                                                                                                                                                                                <div>
                                                                                                                                                                                                      <Breadcrumb title="Upload Projects" />
                                                                                                                                                                                                      <br/>
                                                                                                                                                                                                      <h2>Upload Your Project</h2>
                                                                                                                                                                                                            <form onSubmit={handleSubmit}>
                                                                                                                                                                                                                    <input
                                                                                                                                                                                                                              type="text"
                                                                                                                                                                                                                                        placeholder="Project Title" style={{padding: "10px 12px", borderRadius:"10px"}}
                                                                                                                                                                                                                                                  value={title}
                                                                                                                                                                                                                                                            onChange={(e) => setTitle(e.target.value)}
                                                                                                                                                                                                                                                                    />
                                                                                                                                                                                                                                                                            <input
                                                                                                                                                                                                                                                                                      type="text" style={{padding:"10px 12px", borderRadius:"10px"}}
                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                    <strong>{project.title}</strong> -{" "}
                                                                                                                                                                                                                                                                                                                                                                                                <a href={project.fileUrl} target="_blank" rel="noopener noreferrer">
                                                                                                                                                                                                                                                                                                                                                                                                              View Project
                                                                                                                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                                                                                                                      <button onClick={() => handleDelete(project.id)} className="btn btn-primary">Delete</button>
                                                                                                                                                                                                                                                                                                                                                                                                                                                </li>
                                                                                                                                                                                                                                                                                                                                                                                                                                                        ))}
                                                                                                                                                                                                                                                                                                                                                                                                                                                              </ul>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                  </div>
