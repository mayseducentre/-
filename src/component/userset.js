...
function pushChanges(){
    ...
    var editemail=document.getElementById("emailport").value;
    var editemail=document.getElementById("emailport").value;
    var editimg=document.getElementById("imgport").value;
    var imageurl;
    // var d=new Date();
              ...
              <form action="#" onSubmit={pushChanges}>
                <div className="row mb-3">
                  ...
                  <div className="col-md-8 col-lg-9">
                    <input type="text" id="editimg" placeholder="Enter your image url"className="form-control"/>
                  </div>
                </div>
                <div className="row mb-3" style={{display:"none"}}>
                  <label for="passcoport" className="col-md-4 col-lg-3 col-form-label"></label>
                  <div className="col-md-8 col-lg-9">
                    <input type="text" className="form-control" id="passcoport"/>
                  </div>
                </div>
