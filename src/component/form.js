export default function Form(){
    ...
    return(
        <main>
         ...
         <section className="checkout spad none">
            ...
            <div className="checkout__form">
                    ...
                    <div className="row">
                        <div className="col-lg-8 col-md-6">
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-6">
                                    <div className="checkout__input">
                                        <p>Student Age<span>*</span></p>
                                        <input type="number" id="chk_nm" required/>
                                    </div>
                                </div>
                            </div>
                            <div className="checkout__input">
                                <p>Country<span>*</span></p>
                                <select id="chk_ctr" style={select}>
                ...
                <option value="Zimbabwe">Zimbabwe</option>
                            ...
                            <div className="checkout__input">
                                ...
                                <input type="date"  className="checkout__input__add" id="chk_q" required/>
                            </div>
                            <div className="row">
                                <div className="col-lg-6">
                                    <div className="checkout__input">
                                        <p>Guardian/Parent phone number<span>*</span></p>
                                        <input type="number" id="chk_nom" required/>
                                    </div>
                                </div>
                                <div className="col-lg-6">
                                    <div className="checkout__input">
                                        <p>Guardian/Parent email address<span>*</span></p>
                            ...
                            <div className="checkout__input">
                                <p>Student's Gender<span>*</span></p>
                                <select style={select}>
                            ...
                            <div className="checkout__input">
                                <p>Student Allergies<span>*</span></p>
                                <textarea type="text" placeholder="Allergies" className="checkout__input__add" ></textarea>
                            </div>
                            ...
                            <div className="checkout__input">
                                ...
                                <select style={select}>
                                    ...
                                    <option value="May's Social Media Page">May's Social Media Page</option> 
                                     </select>
                            </div>
                            <div className="checkout__input">
