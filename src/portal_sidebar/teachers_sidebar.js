...
function AssignC() {
  ...
  document.getElementById("creategrade").style.display = "none";
...
function CreateGrade() {
  ...
  document.getElementById("calendarviewing").style.display = "none";
  document.getElementById("messageme").style.display = "none";
  document.getElementById("creategrade").style.display = "block";
}

function Teachersidebar({ user }) {
  return (
    <>
        ...
        <div className="container d-flex align-items-center justify-content-between">
          ...
          <div>
            <a
              href="#/user_setting"
              id="teacherusername"
              style={{ textTransform: "uppercase", color: "whitesmoke" }}
            >
              {user.name}
            </a>
            &nbsp;
      ...
      <aside id="sidebar" className="sidebar">
        <ul className="sidebar-nav" id="sidebar-nav">
          ...
          <li className="nav-item" onClick={CreateGrade}>
            <a className="nav-link collapsed">
      ...
      <div className="bottom-nav animate__animated animate__fadeInUp">
        <a className="fa fa-dashboard" onClick={staffDash}>
          <br />
          <small className="smaller">Dashboard</small>
        </a>
        <a className="fa fa-bar-chart" onClick={AssignC}>
          <br />
          <small className="smaller">Assignments</small>
        </a>
        <a className="fa fa-book" onClick={CreateGrade}>
          <br />
          <small className="smaller">Gradebook</small>
        </a>
        <a className="fa fa-bullhorn" onClick={Message}>
          <br />
          <small className="smaller">Annoucement</small>
        </a>
        <a className="fa fa-filter" onClick={Assess}>
          <br />
          <small className="smaller">Assessment</small>
        </a>
        <a className="fa fa-file" onClick={Register}>
          <br />
          <small className="smaller">Register</small>
        </a>
        <a
          className="fa fa-comments-o"
          title="Staff Chat Room"
          onClick={StaffChatroom}
        >
          <br />
          <small className="smaller">ChatRoom</small>
        </a>
        <a className="fa fa-calendar-o" onClick={viewCal}>
          <br />
          <small className="smaller">Calender</small>
        </a>
        <a className="fa fa-group">
          <br />
          <small className="smaller">Attendance</small>
        </a>
        <a
        ...
        >
          <br />
          <small className="smaller">VR Class</small>
        </a>
        <a className="fa fa-paper" title="Examination">
          <br />
          <small className="smaller">Exams</small>
        </a>
        <a className="fa fa-book" onClick={Lesson}>
          <br />
          <small className="smaller">Notes</small>
        </a>
        <a className="fa fa-user-o" href="#/user_setting">
          <br />
          <small className="smaller">Profile</small>
        </a>
        <a className="fa fa-child" onClick={StudentPerf}>
          <br />
          <small className="smaller">Performance</small>
        </a>
        <a className="fa fa-shield">
          <br />
          <small className="smaller">Support</small>
        </a>
      </div>
    </>
  );
