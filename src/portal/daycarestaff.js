...
import Daycarestaffbar from "../portal_sidebar/daycarestf_sidebar";

function Daycarestaffportal(){
   ...
   return(
    <>
    <div id="main">
        <input type="text" id="daycarestaffid" style={{display:"none"}} readOnly/>
...
export default Daycarestaffportal;